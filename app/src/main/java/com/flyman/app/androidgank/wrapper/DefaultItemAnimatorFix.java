 ...
 * a RecyclerView. RecyclerView uses a DefaultItemAnimatorFix by default.
 *
 * @see RecyclerView#setItemAnimator(RecyclerView.ItemAnimator)
 */
public class DefaultItemAnimatorFix extends SimpleItemAnimator {
     ...
     * {@inheritDoc}
     * <p>
     * If the payload list is not empty, DefaultItemAnimatorFix returns <code>true</code>.
     ...
     * then DefaultItemAnimatorFix will call {@link #animateMove(RecyclerView.ViewHolder, int, int, int, int)} and
